...
Give the developer a consistent, documented diagnostic baseline for iterating on Scribe
in-game — log tailing, a preset dev-world launch, fast reload techniques, and Atlas
reference material — so common diagnosis steps are not re-derived each session.
