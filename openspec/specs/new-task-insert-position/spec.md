# new-task-insert-position

## Purpose
Document-level task creates (footer Add, Shift+right-click, Handbook Add to Scribe) insert at a
player-chosen edge: Top (default) or Bottom. Enter insert-below stays caret-relative.
