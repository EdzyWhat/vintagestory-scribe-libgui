...
- [x] 2.3 Manual playtest: open the Assignment Desk — confirm the nav column shows exactly five
      tabs (Create Assignments, Sent Assignment History, Assignment Inbox, Edit View, Settings)
      with no Read tab/button present.
- [x] 2.4 Manual playtest: switch to Edit View, confirm it still opens the Desk's own document with
...
- [x] 2.5 Regression check: close and reopen the Assignment Desk (and separately, have another
