...
- [x] 3.3 Manual playtest: with Progression Framework installed, click a Progression Framework Quest
...
- [x] 3.4 Manual playtest: click a Progression Framework Quest Link from the pinned-task HUD — confirm
      the same open-to-Quest-Log behavior.
- [x] 3.5 Manual playtest: click an ordinary item Link and a guide-page Link — confirm both still open
      their Handbook page exactly as before (no regression from the branch added in Task 2.1).
- [x] 3.6 Regression check: with Progression Framework NOT installed, confirm a (legacy/orphaned)
