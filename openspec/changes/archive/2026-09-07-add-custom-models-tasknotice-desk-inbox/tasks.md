...
- [x] 3.2 Create `src/Mod/assets/scribe/shapes/item/tasknotice/filled.json`, starting from a copy
...
- [x] 3.3 Update `src/Mod/assets/scribe/itemtypes/tasknotice.json`'s `shape.base` to
