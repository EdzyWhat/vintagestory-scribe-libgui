...
- [x] 4.3 In-game gate: on a WET tablet, click a Link task's name → its Handbook page opens and the
...
- [x] 4.4 In-game gate: repeat 4.3 with cuneiform ON — the name is still clickable and the number
      still edits.
  - Confirmed 2026-08-21 (playtest verdict on file in TESTING.md).
- [x] 4.5 In-game gate: on a Lectern/Notebook EDITOR view, confirm item-row names are NOT clickable
