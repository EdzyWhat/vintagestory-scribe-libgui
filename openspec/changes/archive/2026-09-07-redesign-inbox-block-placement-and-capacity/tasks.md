...
- [x] 4.1 Manual playtest: place an Inbox block against the ground — confirm it renders the
...
- [x] 4.2 Manual playtest: open the Inbox Inventory tab and confirm all 12 slots render — two
...
- [x] 4.3 Manual playtest: with an existing world containing an Inbox block placed before this
