...
- [ ] 3.2 Manual playtest: open a Notebook/Lectern/Tablet dialog, click a Handbook link so the base-game
...
- [ ] 3.3 Manual playtest: same as 3.2 but for a Quest Link opening Progression Framework's Ledger
      (Quest Log tab) instead of the Handbook.
- [ ] 3.4 Manual playtest: with the Handbook/Ledger STILL OPEN on top, click directly on the Scribe
...
- [ ] 3.5 Manual playtest: with a Scribe dialog open and NO vanilla dialog open, confirm normal Scribe
