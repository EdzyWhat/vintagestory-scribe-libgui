...
The settings surface SHALL present its controls in three labeled sections: a Mod Behavior section, a
Window Appearance section, and a HUD Appearance section. The Mod Behavior section SHALL contain the
