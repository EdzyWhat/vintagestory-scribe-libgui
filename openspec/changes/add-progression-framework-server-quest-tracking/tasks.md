...
- [ ] 3.3 Manual playtest: with Progression Framework + Seafarer installed, trigger a server-scoped
...
- [ ] 3.4 Manual playtest: with a server-scoped quest already active from a prior session (this
...
- [ ] 3.5 Manual playtest: deliver an objective item toward a linked server-scoped quest and
...
- [ ] 3.6 Manual playtest: pick a server-scoped quest from the Quest Link picker BEFORE it has ever
...
- [ ] 3.7 Regression check: with only Progression Framework installed and no dependent content mod
