...
- [x] 6.4 Have a second player open the same lectern — confirm both names appear. (Confirmed 2026-07-31, MP.)
...
- [x] 6.7 Confirm another player's entry shows their note as plain text (no input field). (Confirmed 2026-07-31, MP.)
