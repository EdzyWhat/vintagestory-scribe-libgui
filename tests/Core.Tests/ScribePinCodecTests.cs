...
public class ScribePinCodecTests
{
    ...
    [InlineData(1000, 30)]           // above max → clamped down (max raised 10 → 30)
    [InlineData(31, 30)]             // just above the new max
    [InlineData(11, 11)]             // previously re-clamped to 10; 11–30 now stick
    [InlineData(30, 30)]
